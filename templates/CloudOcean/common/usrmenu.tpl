    ...
    <div class="sidebar-content">
        ...
        <nav class="main-menu">
            <ul class="nav metismenu">
              <li class="sidebar-header"><span>订购服务</span></li>
              <li><a href="cart.php" aria-expanded="false"><i class="icon dripicons-inbox"></i><span>选购服务</span></a></li>
                <li class="sidebar-header"><span>{$LANG.overview}</span></li>
                <li><a href="/clientarea.php"><i class="icon dripicons-home"></i><span>{$LANG.clientareatitle}</span></a></li>
                <li class="sidebar-header"><span>控制台</span></li>
                <li><a href="/clientarea.php?action=services&itemlimit=all"><i class="icon dripicons-article"></i><span>{$LANG.clientareanavservices}</span></a></li>
                <li><a href="/clientarea.php?action=domains"><i class="icon dripicons-jewel"></i><span>{$LANG.domainname}</span></a></li>
                <li class="sidebar-header"><span>用户中心</span></li>
                <li class="nav-dropdown">
                    <a class="has-arrow" href="#" aria-expanded="false"><i class="icon dripicons-lock"></i><span>{$LANG.account}</span></a>
                    <ul class="collapse nav-sub" aria-expanded="false">
                        <li><a href="/clientarea.php?action=details"><span>{$LANG['sidebars']['viewAccount']['myDetails']}</span></a></li>
                        <li><a href="/clientarea.php?action=contacts"><span>{$LANG['sidebars']['viewAccount']['contacts/subAccounts']}</span></a></li>
                          <li><a href="/index.php?m=renewal"><span>续费管理</span></a></li>
                        <li><a href="/index.php?m=transfer"><span>转让产品</span></a></li>
                  </ul>
                </li>
                <li class="nav-dropdown">
                    <a class="has-arrow" href="#" aria-expanded="false"><i class="icon dripicons-to-do"></i><span>{$LANG.navbilling}</span></a>
                    <ul class="collapse nav-sub" aria-expanded="false">
                      <li><a href="/clientarea.php?action=invoices&itemlimit=all"><span>{$LANG.invoices}</span></a></li>
                      {if $idcAddfundsEnabled eq 'on'}
                      <li><a href="/clientarea.php?action=addfunds"><span>{$LANG.addfunds}</span></a></li>
                      {/if}
                ...
                <li class="nav-dropdown">
                    <a class="has-arrow" href="#" aria-expanded="false"><i class="icon dripicons-bell"></i><span>{$LANG.notifications}</span></a>
                    <ul class="collapse nav-sub" aria-expanded="false">
                        <li><a href="/clientarea.php?action=emails&itemlimit=all"><span>{$LANG.navemailssent}</span></a></li>
                    
                        <li><a href="/index.php?rp=/announcements"><span>{$LANG.announcementstitle}</span></a></li>
                    </ul>
                </li>
                <li class="nav-dropdown">
                    <a class="has-arrow" href="#" aria-expanded="false"><i class="icon dripicons-help"></i><span>{$LANG.navsupport}</span></a>
                    <ul class="collapse nav-sub">
                        <li><a href="/submitticket.php"><span>{$LANG.navopenticket}</span></a></li>
                        <li><a href="supporttickets.php"><span>{$LANG.clientareanavsupporttickets}</span></a></li>
                      
                    </ul>
                </li>
                <li><a href="/affiliates.php"><i class="icon dripicons-device-desktop"></i><span>{$LANG.affiliatestitle}</span></a></li>
            </ul>
        </nav>
    </div>
</aside>
...
<aside class="sidebar sidebar-left">
    <div class="sidebar-content">
        ...
        <nav class="main-menu">
            <ul class="nav metismenu">
                <li class="sidebar-header"><span>{$LANG.overview}</span></li>
                <li><a href="/clientarea.php"><i class="zmdi zmdi-account"></i><span>登陆</span></a></li>
                <li><a href="/register.php"><i class="zmdi zmdi-account-add"></i><span>{$LANG.register}</span></a></li>
                <li><a href="/pwreset.php"><i class="zmdi zmdi-lock"></i><span>忘记密码</span></a></li>
            </ul>
        </nav>
    </div>
</aside>
