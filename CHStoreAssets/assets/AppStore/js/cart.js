...
var GoodsCart = {
                ...
                if (data.code == 0) {
                    ...
                    $.each(data.data, function (key, val) {
                        ...
                        content += '<li>\n' +
                            ...
                            '              <p class="price">￥' + val.price + '<span>￥' + (val.price - 0) * 2 + '</span><img src="./assets/AppStore/images/f3.png"/></p>\n' +
                            '          </a>\n' +
                            '      </li>';
                    });
    ...
    Success: function (data) {
        ...
        var content = '<div class="gwc1_1" >\n' +
            ...
            '                    <img src="./assets/AppStore/images/mre1.png"/>\n' +
            '                </a>\n' +
            '            </div>\n' +
            '        </div>';
        ...
        $.each(data.data, function (key, val) {
            ...
            content += '<div class="gwcone" id="CartShop_' + val.id + '" data-count="' + val.num + '" data-multi="' + val.multi + '">\n' +
                ...
                '                        <div class="del" data-id="' + val.id + '" data-name="' + val.name + '"><img src="./assets/AppStore/images/del.png"/></div>\n' +
                '                    </div>\n' +
                '                </div>\n' +
                '            </div>';
        });
